...
write a program that plays a game of rock paper scissors between the user and te computer and declares whomever is first to get 5 round wins the winner

The program will have a ui that allows players to play rock, paper, scissors or reset

the inputs will be buttons for rock, paper, scissors and reset
